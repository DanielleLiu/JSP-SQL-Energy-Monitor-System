...
<body >
	...
	<div class="result">
		<form id="editform" name="editform"  action="${ctx}${entityPath}/saverec" method="post">
				...
				<input type="hidden" id="billID" name="billID" value="${storagebill.billID}"/>
					<tr style="border: #D9D9D9 1px solid;">
						...
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
							...
							name="storageEngID"
							data-options="valueField:'id',textField:'text',editable:true,url:'${ctx}/energystorage/getAreas_storageeng?id=${storagebill.billID}',method:'get',required:false,value:'${storagebill.storageEngID}'" />
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
						<td class="left" style="width: 20%;">热值</td>
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
						<input  class="easyui-textbox"   type="text" id="heatValue"  name="heatValue"  value="${storagebill.heatValue}" />
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
						<td class="left" style="width: 20%;">热值系数</td>
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
						<input  class="easyui-textbox"   type="text" id="heatmultiple"  name="heatmultiple"   value="${storagebill.heatmultiple}"/>
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
						<td class="left" style="width: 20%;">折标量</td>
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
						<input  class="easyui-textbox"   type="text" id="energyValue"  name="energyValue"   value="${storagebill.energyValue}"/>
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
						<td class="left" style="width: 20%;">折标系数</td>
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
						<input  class="easyui-textbox"   type="text" id="energyMultiple"  name="energyMultiple"  value="${storagebill.energyMultiple}" />
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
						<td class="left" style="width: 20%;">数量</td>
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
						<input  class="easyui-textbox"   type="text" id="quantity"  name="quantity"   value="${storagebill.quantity}"/>
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
						<td class="left" style="width: 20%;">当前库存数</td>
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
						<input  class="easyui-textbox"   type="text" id="sumBalance"  name="sumBalance"  value="${storagebill.sumBalance}" />
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
						<td class="left" style="width: 20%;">当前库存热量</td>
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
						<input  class="easyui-textbox"   type="text" id="sumHeat"  name="sumHeat"   value="${storagebill.sumHeat}"/>
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
						<td class="left" style="width: 20%;">当前库存折标量</td>
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
						<input  class="easyui-textbox"   type="text" id="sumtce"  name="sumtce"   value="${storagebill.sumtce}"/>
						</td>
					</tr>
				</table>
			</fieldset> 
