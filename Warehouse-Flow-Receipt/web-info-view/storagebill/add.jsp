...
function init(){
	$("#storageID").combotree({ 
		onChange: function (n,o) {
			...
			$.ajax({
				type : "GET",
				url : "${ctx}${entityPath}/selbillNum",
				data : {storageID:n,billType:billType},
				success : function(newstr) {
						document.getElementById("billNum").value=newstr;
					}
	    		});
		}
	});
				...
				<table
					...
					<tr style="border: #D9D9D9 1px solid;">
						...
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
							...
							name="storageID"
							data-options="valueField:'id',textField:'text',editable:true,url:'${ctx}/energyaccountunit/getAreas_unitorstorage?id=',method:'get',required:false,value:'0'" />
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
					...
					<tr style="border: #D9D9D9 1px solid;">
						...
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
							<input class="easyui-datebox"  id="busTime"
							name="busTime" />
						</td>
					</tr>
					</c:if>
					...
					<tr style="border: #D9D9D9 1px solid;">
						...
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
							<input class="easyui-datetimebox"  id="billTime"
							name="billTime" />
						</td>
					</tr>
					<tr style="border: #D9D9D9 1px solid;">
						...
						<td class="right" style="border: #D9D9D9 1px solid;" colspan=3>
							...
							<input type="hidden" id="billType" name="billType" value="${biitype}"/>
						</td>
					</tr>
				</table>
			</fieldset>
